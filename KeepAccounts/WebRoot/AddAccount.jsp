...
<body>
	<div class="">
		<ul class="layui-nav layui-bg-orange">
			...
			<li style="margin-left: 80px;" class="layui-nav-item"><a
				href="Accounting.jsp">记账查询</a></li>

			<li style="margin-left: 80px;" class="layui-nav-item"><a
				href="AddAccount.jsp">添加记账</a></li>
			...
			<li class="layui-nav-item"><a href="javascript:;"><%=request.getSession().getAttribute("username")%></a>
				<dl class="layui-nav-child">
					<dd>
						<a href="UserInformationEdit.jsp">修改信息</a>
					</dd>
					<dd>
	...
	<!-- 	<form class="layui-form"> -->
			<div class="layui-form-item">
				<label class="layui-form-label"> <span class="x-red">*</span>类别
				</label>
				...
				<label class="layui-form-label"> <span class="x-red">*</span>金额
				</label>
				<div class="layui-input-inline">
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-inline" style="width: 41.5%;">
					<textarea placeholder="请输入内容" class="layui-textarea" name="remarks"
						id="remarks"></textarea>
				</div>
				<label class="layui-form-label"> <span class="x-red">*</span>添加时间
				</label>
				<div class="layui-input-inline">
				...
				<button class="layui-btn" id="addcount-button" lay-filter="add"
					style="margin-top: 5%;margin-left: -6.7%;">添加</button>
			</div>
	</div>
	...
	<div class="layui-container">
		<div class="layui-row">
			<div class="layui-col-md12">
				<!-- 表格开始 -->
				<table class="layui-hide" name="accounting" id="accounting"
					lay-filter="accounting"></table>
		...
		<!-- 页面底部 -->
		<p
			style="font-size: 15px;color: #c2c2c2;margin-top: 25px;text-align:center;margin-bottom: 50px;">©
...
<script>
	...
	layui
			.use(
					...
					function() {
						var table = layui.table, form = layui.form, layer = layui.layer, $ = layui.jquery, element = layui.element;
														...
														.confirm(
																...
																function() {
																	$
																			.ajax({
																				type : 'get',
																				url : "addaccountmodel/deleteBill?billid="
																						+ data.billid,
																				dataType : 'json',
																				success : function(
																						data) {
