		...
		<ul class="layui-nav layui-bg-orange">
			...
			<li class="layui-nav-item"><a href="javascript:;">${user.uname }</a>
				<dl class="layui-nav-child">
					...
					<!-- 						<dd><a data-method="confirmTrans">退出</a></dd> -->
				</dl></li>
	...
	<div class="layui-container">
			...
			<div class="layui-row layui-col-space15">
				<div class="layui-col-md4">
					<div class="layui-card">
						...
						<div class="layui-card-body">
							<br> <font style="font-size: 20px;" color="lawngreen">
								+500</font>
				...
				<div class="layui-col-md4">
					<div class="layui-card">
						...
						<div class="layui-card-body">
							<br> <font style="font-size: 20px;" color="red">
								-1000</font>
						</div>
					</div>
				</div>
		...
		<div class="layui-row">
			...
			<div class="layui-col-md6">
				<div id="doughnut"
					style="width: 400px;height:400px;margin-top: 55px;margin-left: 30px;"></div>
			</div>
