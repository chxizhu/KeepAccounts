...
<body>
	...
	<div class="layui-row" style="margin-top: 20px;margin-left: 35%;">
		<div class="layui-input-inline">
			<div font style="font-size: 15px;">
				总收入：<font style="font-size: 20px;" color="lawngreen"> +500</font>
			</div>
		</div>
	</div>
	<div class="layui-row" style="margin-top: 20px;margin-left: 35%;">
		<div font style="font-size: 15px;">
			总支出：<font style="font-size: 20px;" color="red"> - 200</font>
		</div>
	</div>
				...
				<form class="layui-form" action="">
					...
					<div class="layui-inline">
						<input type="text" class="layui-input" name="starttime"
							id="starttime" placeholder="开始时间" placeholder="yyyy-MM-dd">
					</div>

					<div class="layui-inline">
						<input type="text" class="layui-input" name="endtime" id="endtime"
							placeholder="结束时间" placeholder="yyyy-MM-dd">
					</div>
																...
																.confirm(
																		...
																		function() {
																			$
																					.ajax({
																						type : 'get',
																						url : "accountingmodel/deleteBill?billid="
																								+ data.billid,
																						dataType : 'json',
																						success : function(
																								data) {
